    ...
    def _generate_structured_response_once(
        ...
        *,
        ...
        instruction = (
            ...
            "(por ejemplo, 'Número de documento'). "
            "2) 'Header rule' debe contener ÚNICAMENTE los nombres de las columnas del formulario que participan en la "
            "dependencia, sin parámetros internos ni tipos de dato. "
            "   - Ejemplo correcto: 'Header rule' = ['Tipo Documento', 'Número de documento']. "
            "3) Si el campo dependiente tiene parámetros internos (por ejemplo, 'Longitud mínima', 'Longitud máxima'), "
            "'Header' debe contener: "
            "   - la columna condicionante y "
            "   - los nombres de esos parámetros internos. "
            "   NO incluyas en 'Header' el nombre de la columna dependiente cuando existan estos parámetros. "
            "   - Ejemplo esperado: 'Header' = ['Tipo Documento', 'Longitud mínima', 'Longitud máxima']. "
            "4) Si el campo dependiente NO tiene parámetros internos y solo hay listas de valores permitidos, "
            "'Header' debe ser igual a 'Header rule' (columna condicionante y columna dependiente). "
            "5) Ni 'Header' ni 'Header rule' deben contener nombres de tipos de dato ('Texto', 'Número', 'Documento', "
            "'Lista', 'Lista compleja', 'Teléfono', 'Correo', 'Fecha'): esos nombres son solo contenedores dentro de 'Regla'. "

            "En 'reglas especifica', el valor de la columna condicionante (por ejemplo, 'Tipo Documento': 'DNI') debe ir junto con "
